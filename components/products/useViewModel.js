...
export default function useViewModel() {
  ...
  function calculateFinalPrice(basePrice, increaseRate, discountRate, isDiscounted) {
    console.log(basePrice, increaseRate, discountRate)
    ...
    try {
      ...
      if (images.length >= 0) {
        const payload = {
          ...
          discountedPrice:calculateFinalPrice(currentProduct.regularPrice,currentProduct.interest, currentProduct.discount)
        };
        ...
        if (editIndex === null) {
          ...
          console.log("test",hasFeaturedImage, { id: deleteProductId, updatedProduct: newPayload } )
