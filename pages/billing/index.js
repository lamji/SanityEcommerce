          ...
          <Col className="border-end col-billing" lg={6} xs={12}>
            ...
            <Row className="mb-3">
              <Form.Group as={Col} md="12" controlId="validationCustom03">
                ...
                <Form.Control
                  type="text"
                  placeholder="House #, Street, Brangay ...."
                  required
                />
              </Form.Group>
            ...
            <div>
              <div className="head-cart">
                ...
                <Link href="/" className="linkNext">
                  <h6 className="color-primary linkNext">Continue Shopping <AiOutlineArrowRight /></h6>
                </Link>
              </div>
              ...
              <div className="preview-items">
                {cartItems &&
                  cartItems.map((res) => {
                    const totalPrice2 =
                      parseInt(res?.quantity) * parseInt(res?.price);
                    return (
              ...
              <div>
                ...
                <p className="text-end p-0">
                  Shipping Fee:{" "}
                  <span className="span">₱{shippingFee.toFixed(2)}</span>
                </p>
              ...
              <Button type="submit" className="btnPay">{modePayment === "" || modePayment === "cod" ? "Confirm Order ": "Pay Now"}</Button>
            </div>
          </Col>
        </Row>
